  ...
  return (
    <IndexLayout className={`${HomePosts}`}>
      <Helmet>
        ...
        <meta
          property="og:image"
          content={config.siteUrl + props.data.shareImage.childImageSharp.fluid.src}
        />
      ...
      <Wrapper>
        ...
        >
          <div className={`${inner}`}>
            <SiteHeaderContent className="siteheadercontent">
              <SiteTitle>
                {props.data.logo ? (
                  <img
...
export const pageQuery = graphql`
  query {
    ...
    shareImage: file(relativePath: { eq: "img/share.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 2000) {
          ...GatsbyImageSharpFluid
        }
